...
@Component({
  selector: 'app-qr-downloadable',
  standalone: true,
  imports: [MatButtonModule, QRCodeModule, MatCardModule],
  templateUrl: './qr-downloadable.component.html',
  styleUrl: './qr-downloadable.component.scss',
})
export class QrDownloadableComponent {
  public initial_state = {
    ...
    // imageSrc: './assets/images/paynow-white.jpg',
    imageSrc: undefined,
    imageHeight: 75,
    imageWidth: 75,
    margin: 4,
